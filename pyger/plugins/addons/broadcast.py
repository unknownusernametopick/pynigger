...
@Ger.cmd("broadcast", owner_only=True)
async def broadcast(bot: Ger, msg: Message):
    ...
    for user in users:
        try:
            ...
            Ger.log(f"Exception occurred while sending message to user with id {user}: {e}", "warning")
