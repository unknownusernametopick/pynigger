...
from pyger.plugins.ger import HOME_BUTTON, MAIN_BUTTONS
from pyrogram.types import InlineKeyboardMarkup, CallbackQuery
from pyger.plugins.helpers import replace, module, replace_commands


@Ger.callback(query=['home', 'about', 'help'])
async def basic_cb(bot: Ger, cb: CallbackQuery):
