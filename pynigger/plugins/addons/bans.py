...
from pynigger.config import ENV
from pynigger.plugins.helpers import db
from pyrogram.errors import PeerIdInvalid


@Nigger.cmd("botban", owner_only=True)
async def ban_users(bot: Nigger, msg):
...
@Nigger.cmd("botunban", owner_only=True)
...
@Nigger.cmd("botbanlist", owner_only=True)
async def ban_list(bot: Nigger, msg):
    number = 0
