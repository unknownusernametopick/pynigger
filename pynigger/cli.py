...
def main():
    ...
    cwd = os.getcwd()
    parser.add_argument('-v', '--version', help='check the current pynigger version installed', action='store_true')
...
def boilerplate(special=False):
    ...
    if special:
        os.system('ghclone https://github.com/unknownusernametopick/PyNigger/tree/master/boilerplate_nigger_bots')
    else:
        os.system('ghclone https://github.com/unknownusernametopick/PyNigger/tree/master/boilerplate')
